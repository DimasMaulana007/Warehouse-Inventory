...
$kkd=mysqli_query($koneksi,"select * from kode_bahan,supplier,jenis_bahan where kode_bahan.id_supplier=supplier.id_supplier and kode_bahan.id_jenis_bahan=jenis_bahan.id_jenis_bahan");
							...
							<div class='x_panel'>
								...
								<div class='x_content'>
									...
									<form id='demo-form2' method='post' data-parsley-validate class='form-horizontal form-label-left'>
										...
										<div class='item form-group'>
											<label class='col-form-label col-md-3 col-sm-3 label-align' for='first-name'>Kode Bahan <span class='required'>:</span>
											</label>
											<div class='col-md-3 col-sm-3 '>
