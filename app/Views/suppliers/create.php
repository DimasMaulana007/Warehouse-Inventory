<section class="content-header"><div class="container-fluid"><div class="col-sm-6"><h1>Tambah Pemasok</h1></div></div></section>
<section class="content"><div class="container-fluid">
    <div class="card card-default">
        <div class="card-header"><h3 class="card-title">Form Data Pemasok</h3><a href="?route=suppliers" class="btn btn-sm btn-danger float-right">Batal</a></div>
        <form action="?route=suppliers/store" method="post" class="form-horizontal">
            <div class="card-body">
                <div class="form-group row"><label class="col-sm-2 offset-sm-2 col-form-label">Nama Pemasok</label><div class="col-sm-5"><input type="text" name="name" class="form-control" required></div></div>
